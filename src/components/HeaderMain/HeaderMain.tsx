        ...
        <div className='grid grid-cols-12 gap-4 mt-4 items-end'>
          ...
          <div className='col-span-1 justify-self-end'>
            {isAuthenticated && (
                  ...
                  <div className='bg-white relative shadow-sm rounded-sm border border-gray-200 max-w-[400px] text-sm'>
                    {purchasesInCart && purchasesInCart.length > 0 ? (
                      <div className='p-2'>
                        ...
                        <div className='mt-5'>
                          {purchasesInCart.slice(0, maxPurchases).map((purchase) => (
                            <div className='mt-4' key={purchase._id}>
                              <div className='flex'>
                                ...
                                <div className='ml-2 flex-shrink-0'>
                                  <span className='text-orange'>{formatInitCurrency(purchase.product.price)}₫</span>
                                </div>
                              </div>
                            </div>
                          ))}
                        ...
                        <div className='flex mt-6 items-center justify-between'>
                          <div className='capitalize text-xs'>
                            {purchasesInCart.length > maxPurchases ? purchasesInCart.length - maxPurchases : ''} sản
                            phẩm trong giỏ hàng
                          </div>
                          <Link
                            to={path.cart}
                            className='Link capitalize bg-orange hover:bg-opacity-80 px-4 py-2 rounded-sm text-white'
                          >
                            Xem Giỏ Hàng
                          </Link>
                        </div>
                      ...
                      <div className='p-4 text-center'>
                        <img
                          src='https://png.pngtree.com/png-clipart/20190903/original/pngtree-cute-cartoon-shopping-cart-icon-png-image_4421108.jpg'
                          alt='Giỏ hàng trống'
                          className='mx-auto w-20 h-20'
                        />
                        <p className='text-gray-500 mt-2'>Chưa có sản phẩm </p>
                      </div>
                    )}
                  </div>
                }
              >
                <div className='relative cursor-pointer'>
                  ...
                  {purchasesInCart && purchasesInCart.length > 0 && (
                    <span className='absolute -top-1 -right-1 bg-white text-orange rounded-full w-5 h-5 flex items-center justify-center text-xs'>
            ...
            {!isAuthenticated && (
              <Popover
                renderPopover={
                  <div className='flex flex-col justify-center items-center p-4 bg-white w-[300px] h-[300px] rounded-sm shadow-md'>
                    <img
                      src='https://png.pngtree.com/png-clipart/20190903/original/pngtree-cute-cartoon-shopping-cart-icon-png-image_4421108.jpg'
                      alt='Giỏ hàng trống'
                      className='w-20 h-20'
